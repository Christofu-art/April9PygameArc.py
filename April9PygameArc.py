...
pygame.draw.arc(screen, chartreuse,     (200, 150, 400, 400), 3*math.pi/2,     4*math.pi/2,      12)

# Middle Circle 
pygame.draw.arc(screen, purple,  (180, 130, 440, 440), 7*math.pi/4,  9*math.pi/4,  12)
pygame.draw.arc(screen, green,  (180, 130, 440, 440), 9*math.pi/4,  3*math.pi/4,  12)
...
pygame.draw.arc(screen, rose,    (160, 110, 480, 480), 3*math.pi/2,  10*math.pi/6,    12)
